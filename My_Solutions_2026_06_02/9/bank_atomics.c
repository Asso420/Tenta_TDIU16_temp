...
b)
Ja, för att i funktione "bank_new_account" används variabeln "name" och "balance" för att 
skap bakkontot, läses de på ett säkert sätt, då ska det inte vara något problem. 
